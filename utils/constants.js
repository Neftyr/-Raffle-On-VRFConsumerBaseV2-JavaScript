// ABI Of VRFCoordinatorV2Interface From: https://goerli.etherscan.io/address/0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D#code
const vrfCoordinatorV2Interface_abi = [
    {
        inputs: [
    ...
    { inputs: [{ internalType: "uint256", name: "blockNum", type: "uint256" }], name: "BlockhashNotInStore", type: "error" },
    {
        inputs: [
    ...
    { inputs: [{ internalType: "address", name: "proposedOwner", type: "address" }], name: "MustBeRequestedOwner", type: "error" },
    ...
    { inputs: [{ internalType: "bytes32", name: "keyHash", type: "bytes32" }], name: "ProvingKeyAlreadyRegistered", type: "error" },
    ...
    { inputs: [], name: "TooManyConsumers", type: "error" },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: "int256", name: "fallbackWeiPerUnitLink", type: "int256" },
            {
                components: [
    ...
    { inputs: [], name: "MAX_CONSUMERS", outputs: [{ internalType: "uint16", name: "", type: "uint16" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "MAX_NUM_WORDS", outputs: [{ internalType: "uint32", name: "", type: "uint32" }], stateMutability: "view", type: "function" },
    {
        inputs: [],
    ...
    { inputs: [], name: "getCurrentSubId", outputs: [{ internalType: "uint64", name: "", type: "uint64" }], stateMutability: "view", type: "function" },
    {
        inputs: [],
    ...
    { inputs: [{ internalType: "address", name: "to", type: "address" }], name: "recoverFunds", outputs: [], stateMutability: "nonpayable", type: "function" },
    {
        inputs: [
...
module.exports = {
    vrfCoordinatorV2Interface_abi,
    linkTokenInterface_abi,
}
